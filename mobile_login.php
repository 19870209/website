...
<head>
    ...
    <meta name="description" content="E-Learning CBT SMK SINAR FAJAR CIKIJING">
    <meta name="author" content="e-learning, smk, spm, sd, smp, purwokerto, lms">

    <meta name="docsearch:language" content="en">
    <meta name="docsearch:version" content="4.5">

    <title>E-Learning CBT SMK SINAR FAJAR CIKIJING</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= $homeurl ?>/dist/img/change 2.png">
    <link rel="manifest" href="<?= $homeurl ?>/dist/pwa/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?= $homeurl ?>/dist/img/change 2.png">
...
<body class="text-center">
    ...
    <form class="form-signin" action="<?= $homeurl ?>/mobile_login.php" method="POST" name="login" style="z-index: 2;">
        <img class="mb-4" src="<?= $homeurl ?>/dist/img/change 2.png" alt="" width="120" height="120">
